...
insert into Eventos(Fecha, Tiempo_anul, Tiempo_penal, Penalizacion, Id_Espectaculo) values ('2015-05-7 11:17:00', 2, 5, 20, 2);
...
insert into Define(Id_Evento,Id_Grada, PrecioJubilado, PrecioAdulto, PrecioInfantil, PrecioParado, PrecioBebe, MaxCliente, NumLocalidadesLibres, NumLocalidadesPrereservadas, 
NumLocalidadesReservadas, NumLocalidadesDeterioradas) values (2, 5, 50, 80, 45, 40, 20, 5, 1, 0, 0, 49);
