...
insert into Eventos(Fecha, Tiempo_anul, Tiempo_penal, Penalizacion, Id_Espectaculo, Estado) values ('2015-05-1 20:45:00', 5, 2, 20, 1, 'Finalizado');
...
insert into Reservas(Id_Cliente,Id_Evento,Id_Grada,NumEntradasJubilado,NumEntradasAdulto,NumEntradasInfantil,NumEntradasParado,NumEntradasBebe,Reservada) values (1,1,1,1,1,0,1,0,1);
